...
export class IndividualComponent implements OnInit {
  ...
  constructor(private serviceIndividual:IndividualService, fb: FormBuilder) {
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: "org.acme.landregistry.Individual",
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceIndividual.updateParticipant(form.get("id").value,this.participant)
		.toPromise()
		.then(() => {
			this.errorMessage = null;
		})
